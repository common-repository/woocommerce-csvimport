...
class woocsv_import {
	...
	public function run_import() {
		...
		if ( empty( $_POST[ 'batch_code' ] ) ) {
			...
			if ( $batch_code ) {
				...
				$separator   = ( in_array( $_POST[ 'separator' ], [ ';', ',' ] ) ? $_POST[ 'separator' ] : ';' );
		...
		//get the lines
		$lines = $this->get_lines_from_file( $batch[ 'filename' ], $from, $till, $batch[ 'separator' ] );
	...
	public function get_lines_from_file( $filename, $from, $till, $separator, $get_total_rows = FALSE ) {
